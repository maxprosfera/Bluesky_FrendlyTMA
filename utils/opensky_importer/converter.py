...
class ScenarioConverter:
    ...
    def _build_scenario(self, tracks: list, start_dt: datetime) -> list:
        ...
        header = [
            ...
            "",
            "# --- Visual Elements ---",
            "00:00:00.00> POLY StockholmTMA 60.2994 18.2131 60.2661 18.5547 60.0353 19.3136 59.6736 19.8281 59.5994 19.2736 59.2550 18.9683 59.0420 18.7547 58.8325 18.5394 58.7525 18.4572 58.5831 17.9328 58.6164 17.4569 58.9786 17.2233 59.0119 16.7078 59.0494 16.2678 59.3239 16.3183 59.7494 16.4467 60.2328 17.5967",
            "",
